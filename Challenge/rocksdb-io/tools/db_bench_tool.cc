 ...
 public:
  ...
  void FinishedOps(uint64_t micros, int64_t num_ops,
    ...
    if (myusecs_since_last > 1000000) {
      // write
      if (hist_.find(kWriteHiccup) != hist_.end()) {
        fprintf(fp_op_hiccup_report, "%8.0f  %8ld  ", (now - start_) / 1000000.0,
